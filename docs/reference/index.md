...
Detailed reference documentation for each component of the toolkit.
{: .fs-6 .fw-300 }

---

This section provides in-depth technical documentation for researchers and practitioners who want to understand the methodology, adapt the analysis, or extend the toolkit for their own studies.
